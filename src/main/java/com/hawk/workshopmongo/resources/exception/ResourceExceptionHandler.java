package com.hawk.workshopmongo.resources.exception;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objectNotFound(ObjectNotFoundException onfe, HttpServletRequest request) {
		...
		StandardError error = new StandardError(System.currentTimeMillis(), status.value(), "Não encontrado", onfe.getMessage(), request.getRequestURI());
